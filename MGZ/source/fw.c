...
u8 init_fw()
{
	...
	if(( lv2peek(FW_DATE_OFFSET_492C    )==FW_DATE_1_492C) &&
		( lv2peek(FW_DATE_OFFSET_492C + 8)==FW_DATE_2_492C) )
	{

		firmware = 0x492C;

		OFFSET_2_FIX = OFFSET_2_FIX_492C;
		LV2MOUNTADDR_ESIZE = LV2MOUNTADDR_ESIZE_492C;
		LV2MOUNTADDR_CSIZE = LV2MOUNTADDR_CSIZE_492C;
		OFFSET_FIX = OFFSET_FIX_492C;
		HV_START_OFFSET = HV_START_OFFSET_492C;
		OFFSET_FIX_2B17 = OFFSET_FIX_2B17_492C;
		OFFSET_FIX_LIC = OFFSET_FIX_LIC_492C;
		OFFSET_FIX_3C = OFFSET_FIX_3C_492C;
		TOC = TOC_492C;
		SYSCALL_TABLE = SYSCALL_TABLE_492C;
		HTAB_OFFSET = HTAB_OFFSET_492C;
		HTAB_PATCH1 = HTAB_PATCH1_492C;
		HTAB_PATCH2 = HTAB_PATCH2_492C;
		HTAB_PATCH3 = HTAB_PATCH3_492C;
		MMAP_OFFSET1 = MMAP_OFFSET1_492C;
		MMAP_OFFSET2 = MMAP_OFFSET2_492C;
		SPE_OFFSET = SPE_OFFSET_492C;
		LV2MOUNTADDR = LV2MOUNTADDR_492C;
		OPEN_HOOK = OPEN_HOOK_492C;
		BASE_ADDR = BASE_ADDR_492C;
		OFFSET_1_IDPS = OFFSET_1_IDPS_492C;
		OFFSET_2_IDPS = OFFSET_2_IDPS_492C;

		PAYLOAD_SKY_SIZE = payload_sky_492C_bin_size;
		PAYLOAD_SKY = (u64) payload_sky_492C_bin;
		UMOUNT_SIZE = umount_492C_bin_size;
		UMOUNT = (u64) umount_492C_bin;
		MAMBA_SIZE = mamba_492C_lz_bin_size;
		MAMBA = (u64) mamba_492C_lz_bin;
		MAMBA_LOADER_SIZE = mamba_loader_492C_bin_size;
		MAMBA_LOADER = (u64 *) mamba_loader_492C_bin;
		ERK_DUMPER_SIZE = erk_dumper_492C_bin_size;
		ERK_DUMPER = (u64 *) erk_dumper_492C_bin;
